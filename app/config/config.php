...
define('REDIS_DATABASE', (int) ($_ENV['REDIS_DATABASE'] ?? 0));
define('REDIS_PREFIX', $_ENV['REDIS_PREFIX'] ?? 'sintoniza:');
...
define('IMMEDIATE_FEED_FETCH', isset($_ENV['IMMEDIATE_FEED_FETCH']) ? filter_var($_ENV['IMMEDIATE_FEED_FETCH'], FILTER_VALIDATE_BOOLEAN) : true);
