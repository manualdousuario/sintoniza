...
/**
 * Feed URL canonicalization. Data integrity depends on this behaviour: feeds,
 * subscriptions and feed_aliases are all joined through these normalized forms,
 * so changing it silently splits existing rows.
 */
class Url
{
    ...
    /** For media URLs only — feed URLs must go through normalizeFeed(). */
    ...
    /**
     * Collapses host/case/tracking variations but deliberately keeps http and
     * https distinct — that pair is resolved later by following redirects.
     */
