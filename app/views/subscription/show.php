...
<?php if (isset($subscription->title, $subscription->image_url)): ?>
    <div class="row mb-4">
        <div class="col-12 col-md-2">
            <img class="rounded w-100 h-auto border" width="150" height="150" src="<?php echo htmlspecialchars($subscription->image_url); ?>">
        </div>
        <div class="col-12 col-md-10">
            <h2 class="fs-3">
                <?php if (!empty($subscription->url)): ?>
                    <a href="<?php echo htmlspecialchars($subscription->url); ?>" class="link-dark" target="_blank"><?php echo htmlspecialchars($subscription->title); ?></a>
                <?php else: ?>
            ...
            <li class="list-group-item p-3">
                <div class="episode_info d-flex gap-3">
                    ...
                    <div class="data flex-grow-1">
                        <h4 class="fs-6 mb-1">
                            <a class="link-dark" href="/subscription/<?php echo $subscription->subscription_id; ?>/episode/<?php echo $ep->id; ?>">
    ...
    <?php if ($pages > 1): ?>
        <nav>
            <ul class="pagination">
                <?php if ($page > 1): ?>
                    <li class="page-item">
                        <a class="page-link" href="/subscription/<?php echo $subscription->subscription_id; ?>?page=<?php echo $page - 1; ?>">&laquo;</a>
                    </li>
                <?php endif; ?>

                <?php for ($p = max(1, $page - 2); $p <= min($pages, $page + 2); $p++): ?>
                    <li class="page-item <?php echo $p === $page ? 'active' : ''; ?>">
                        <a class="page-link" href="/subscription/<?php echo $subscription->subscription_id; ?>?page=<?php echo $p; ?>"><?php echo $p; ?></a>
                    </li>
                <?php endfor; ?>

                <?php if ($page < $pages): ?>
                    <li class="page-item">
                        <a class="page-link" href="/subscription/<?php echo $subscription->subscription_id; ?>?page=<?php echo $page + 1; ?>">&raquo;</a>
                    </li>
                <?php endif; ?>
            </ul>
        </nav>
