<div class="container">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="user_list-tab" data-bs-toggle="tab" data-bs-target="#user_list"
                type="button" role="tab" aria-controls="user_list" aria-selected="true">
                <?php echo __('admin.user_list'); ?>
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="add_user-tab" data-bs-toggle="tab" data-bs-target="#add_user" type="button"
                role="tab" aria-controls="add_user" aria-selected="false">
    ...
    <div class="tab-content" id="dashboard">
        ...
        <div class="tab-pane fade show active border border-top-0 bg-white rounded-bottom" id="user_list"
            role="tabpanel" aria-labelledby="user_list-tab">
                ...
                foreach ($users as $user) {
                    ...
                    <li class="list-group-item p-3">
                        ...
                        <form method="post" action="" class="d-inline"
                            onsubmit="return confirm('<?php echo __('admin.confirm_delete'); ?>');">
        ...
        <div class="tab-pane fade border border-top-0 bg-white rounded-bottom" id="add_user" role="tabpanel"
            aria-labelledby="add_user-tab">
